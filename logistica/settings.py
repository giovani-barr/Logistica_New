"""
Django settings for logistica_project project.
"""
...
# OSRM Router URL
OSRM_ROUTER_URL = config('OSRM_ROUTER_URL', default='https://router.project-osrm.org/route/v1')
